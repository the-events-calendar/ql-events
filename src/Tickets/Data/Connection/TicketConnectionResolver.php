...
class TicketConnectionResolver extends AbstractConnectionResolver {
	...
	public function get_query_args() {
		...
		$query_args = [
			...
			'post_type'           => $this->post_type ?: array_keys( Utils::get_et_types() ),
			// This is all we need.
			'fields'              => 'ids',
	...
	public function sanitize_post_stati( $stati ) {
		...
		/**
		 * If there are no allowed statuses to pass to WP_Query, prTicket the connection
		 * from executing
		 *
		 ...
		 * }
		 *
		 * We can safely prTicket the execution of the query because they are asking for content
