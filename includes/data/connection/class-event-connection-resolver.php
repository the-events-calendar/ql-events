 ...
 */
class Event_Connection_Resolver extends PostObjectConnectionResolver {
	...
	public function get_query() {
		...
		$orderby = ! empty( $this->query_args['orderby'] ) ? $this->query_args['orderby'] : [ 'event_date' => 'DESC' ];
	...
	public function is_valid_offset( $offset ) {
		return (bool) tribe_get_event( absint( $offset ) );
	}
	...
	public function filtered( $query, array $where_args ) {
		...
		$query_args = Utils::map_input( $where_args, $fields );
