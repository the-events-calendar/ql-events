<?php  //[STAMP] e3c90497b53bee3f6d0436dc87769764
...
trait WpunitTesterActionsActions
{
     ...
     *
     *
     * @see \Helper\Wpunit::activate_tec()
     */
    public function activate_tec() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('activate_tec', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Wpunit::activate_ecp()
     */
    public function activate_ecp() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('activate_ecp', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Wpunit::activate_et()
     */
    public function activate_et() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('activate_et', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Wpunit::activate_etp()
     */
    public function activate_etp() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('activate_etp', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Wpunit::deactivate_tec_plugins()
     */
    public function deactivate_tec_plugins() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deactivate_tec_plugins', func_get_args()));
    }
}
