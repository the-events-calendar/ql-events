...
class RsvpAttendee {
	 ...
	 */
	public function create_many_attendees_for_ticket( int $count, int $ticket_id, int $post_id, array $overrides = [] ): array {
	 ...
	 * @param bool  $optout
	 */
	public function optout_attendees( array $attendees, bool $optout = true ) {
